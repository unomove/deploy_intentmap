...
using Robot = import "robot.capnp";
...
struct LiveLocationKalman {
  ...
  # https://github.com/commaai/openpilot/tree/master/lib/transformations
...
struct Event {
  ...
  union {
    ...
    floorplan @86 :Robot.Floorplan; 
    source  @87   :Robot.Exit;
    target  @88   :Robot.Exit;
    pose    @89   :Robot.Pose;
    state   @90   :Robot.Exit;
    info    @91   :Robot.Info;
